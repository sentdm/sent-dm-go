...
type UserListResponseData struct {
	...
	Pagination UserListResponseDataPagination `json:"pagination"`
...
// Pagination metadata for list responses
type UserListResponseDataPagination struct {
	// Cursor-based pagination. Never populated — see Cursors.
	//
	// Deprecated: deprecated
	Cursors UserListResponseDataPaginationCursors `json:"cursors" api:"nullable"`
...
// Returns the unmodified JSON received from the API
func (r UserListResponseDataPagination) RawJSON() string { return r.JSON.raw }
func (r *UserListResponseDataPagination) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// Deprecated: deprecated
type UserListResponseDataPaginationCursors struct {
...
// Returns the unmodified JSON received from the API
func (r UserListResponseDataPaginationCursors) RawJSON() string { return r.JSON.raw }
func (r *UserListResponseDataPaginationCursors) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
